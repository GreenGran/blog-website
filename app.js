...
app.get("/about", function (req, res) {
  ...
  res.render("about.ejs", {
    ...
    paragraphContant: aboutContent,
    Title: "about".toLocaleUpperCase()
  });
});
...
app.get("/contact", function (req, res) {
  ...
  res.render("contact.ejs", {
    ...
    paragraphContant: contactContent,
    Title: "contact".toLocaleUpperCase()
  });
});
...
app.post("/compose", function (req, res) {
  ...
  let inputContant = req.body.post;
  let post = {
